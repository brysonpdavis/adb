...
<div class="flex w-full max-w-[924px] flex-col gap-4 text-pretty">
	...
	<div class="mt-2 flex w-full flex-row gap-8">
		<FunButton alt="test" text="explore my work" href="/yes" />
		<FunButton alt="test" text="my cv" href="/yes" />
	</div>
</div>
<div class="flex w-full justify-end pt-2">
	<NameRound />
</div>
<div class="m-0 h-72 shrink-0 p-0"></div>
